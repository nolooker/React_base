...
function App() {
	...
	const [model, setModel] = useState('Rolls-Royce');
	const [year, setYear] = useState(2007);
	const [color, setColor] = useState('black');
	const [image, setImage] = useState('Rolls-Royce.jpg');
